...
class Settings:
    ...
    shop_items: Sequence[dict[str, Any]] = field(
        default_factory=lambda: (
            ...
            {"id": 10, "type": "balance_icon", "name": "Мешок с деньгами", "price": 8_000, "value": "💸"},
            {"id": 11, "type": "balance_icon", "name": "Пачка баксов", "price": 12_000, "value": "💵"},
            {"id": 12, "type": "balance_icon", "name": "Бриллиант", "price": 150_000, "value": "💎"},
            {
                "id": 20,
                "type": "credit_line",
