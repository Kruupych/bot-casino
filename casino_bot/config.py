...
class Settings:
    ...
    shop_items: Sequence[dict[str, Any]] = field(
        default_factory=lambda: (
            ...
            {"id": 2, "type": "title", "name": "Карточный шулер", "price": 15_000},
            {"id": 3, "type": "title", "name": "Любимчик Фортуны", "price": 75_000},
            {"id": 4, "type": "title", "name": "Коллекционер джекпотов", "price": 150_000},
            {"id": 5, "type": "title", "name": "Тень Удачи", "price": 250_000},
            {"id": 6, "type": "title", "name": "Легенда казино", "price": 500_000},
            ...
            {"id": 12, "type": "balance_icon", "name": "Бриллиант", "price": 1_000_000, "value": "💎"},
            {"id": 13, "type": "balance_icon", "name": "Золотой жетон", "price": 200_000, "value": "🪙"},
            {"id": 14, "type": "balance_icon", "name": "Корона капитана", "price": 350_000, "value": "👑"},
            {"id": 15, "type": "balance_icon", "name": "Пламя удачи", "price": 600_000, "value": "🔥"},
            {
                "id": 20,
                "type": "credit_line",
