...
class Settings:
    ...
    slot_machines: Sequence[dict[str, Any]] = field(
        default_factory=lambda: (
            ...
            },
            {
                ...
                "reel": ("🐍", "🐞", "👁️", "🏺", "𓇶", "🦂", "🕯️", "🗿"),
                "wild_symbol": "🗿",
                "jackpot_percent": 0.025,
                "triple_payouts": {"🐍": 30, "🐞": 20, "👁️": 15, "🏺": 10, "𓇶": 8, "🦂": 6, "🕯️": 6},
                "double_payouts": {"🐍": 4, "🐞": 3, "👁️": 2, "🏺": 2, "𓇶": 2, "🦂": 1, "🕯️": 1},
            ...
            },
            {
                ...
                "triple_payouts": {"🪐": 30, "🚀": 20, "👽": 15, "☄️": 10, "✨": 8, "🌠": 6, "🛰️": 6},
                "double_payouts": {"🪐": 4, "🚀": 3, "👽": 2, "☄️": 2, "✨": 2, "🌠": 1, "🛰️": 1},
    ...
    shop_items: Sequence[dict[str, Any]] = field(
        default_factory=lambda: (
            {"id": 1, "type": "title", "name": "Мусор", "price": 100},
            {"id": 2, "type": "title", "name": "Банкрот со стажем", "price": 1_000},
            {"id": 3, "type": "title", "name": "Карточный шулер", "price": 15_000},
            {"id": 4, "type": "title", "name": "Любимчик фортуны", "price": 75_000},
            {"id": 5, "type": "title", "name": "Коллекционер джекпотов", "price": 150_000},
            {"id": 6, "type": "title", "name": "Еврей", "price": 500_000},
            {"id": 7, "type": "title", "name": "Сдал дурку в ломбард", "price": 1_000_000},
            {"id": 8, "type": "title", "name": "Легенда казино", "price": 5_000_000},
            {"id": 10, "type": "balance_icon", "name": "Мешок с деньгами", "price": 25_000, "value": "💰"},
            {"id": 11, "type": "balance_icon", "name": "Пачка баксов", "price": 100_000, "value": "💵"},
            {"id": 12, "type": "balance_icon", "name": "Золотой жетон", "price": 300_000, "value": "🪙"},
            {"id": 13, "type": "balance_icon", "name": "Пламя удачи", "price": 600_000, "value": "🔥"},
            {"id": 14, "type": "balance_icon", "name": "Бриллиант", "price": 1_500_000, "value": "💎"},
            {"id": 15, "type": "balance_icon", "name": "Корона капитана", "price": 5_000_000, "value": "👑"},
            {
                "id": 20,
                "type": "credit_line",
